...
### para obter a quantidade de vôos redirecionados basta exibir valores = 1 e  contar a quantidade de linhas


echo -n  "O número de vôos que precisaram ser redirecionados foi de: "
cut -d, -f25 2006-sample.csv | grep "1" | wc -l

### O número de vôos que precisaram ser redirecionados foi de: 2749
